		...
		config = function()
			...
			require("tokyonight").setup({
				...
				on_highlights = function(hl, c)
					...
					-- fzf-lua
					hl.FzfLuaNormal = { fg = fg, bg = black }
					hl.FzfLuaBorder = { fg = comment, bg = black }
					hl.FzfLuaTitle = { fg = fg, bold = true }

					hl.FzfLuaPrompt = { fg = blue }
					hl.FzfLuaCursor = { bg = bg_highlight }

					hl.FzfLuaPreviewNormal = { fg = fg, bg = bg_dark }
					hl.FzfLuaPreviewBorder = { fg = comment, bg = bg_dark }

					hl.FzfLuaHeader = { fg = comment }
					hl.FzfLuaPath = { fg = blue }
					hl.FzfLuaLineNr = { fg = dark5 }
